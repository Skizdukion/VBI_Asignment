...
where
	...
	C::Api: pallet_kitties_rpc_runtime_api::KittiesStorageApi<Block>,
	P: TransactionPool + 'static,
{
	...
	io.extend_with(pallet_kitties_rpc::KittiesStorageApi::to_delegate(pallet_kitties_rpc::KittiesStorage::new(client.clone())));
